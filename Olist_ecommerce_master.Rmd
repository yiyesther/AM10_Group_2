...
ggplot(data = voucher_ins, aes(x = value_range, y = median_ins,
  ...
  geom_text(
    data = data.frame(x = 5, y = 3, label = label1),
    ...
    geom_text(
    data = data.frame(x = 2.5, y = 5, label = label2),
    aes(x = x, y = y, label = label),
    colour="navyblue",
    family="Lato",
    hjust = 0.5,
